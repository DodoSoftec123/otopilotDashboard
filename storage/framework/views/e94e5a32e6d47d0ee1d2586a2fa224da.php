            ...
            <div class="row justify-content-between">
                <div class="col-lg-5 pt-120">
                    <div class="left-area">
                        ...
                        <div class="single-item d-flex align-items-center">
                            <div class="icon-area">
                                <img src="<?php echo e(asset('assets/auth/img/feature-list-icon-1.png')); ?>" alt="icon">
                            </div>
                            <p>Same-day delivery to dozens of countries</p>
                        </div>
                        <div class="single-item d-flex align-items-center">
                            <div class="icon-area">
                                <img src="<?php echo e(asset('assets/auth/img/feature-list-icon-2.png')); ?>" alt="icon">
                            </div>
                        ...
                        <div class="single-item d-flex align-items-center">
                            <div class="icon-area">
                                <img src="<?php echo e(asset('assets/auth/img/feature-list-icon-3.png')); ?>" alt="icon">
                            </div>
                ...
                <div class="col-lg-6 z-1 text-center d-flex justify-content-center pb-120">
                    <div class="form-box">
                        ...
                        <p class="alr-acc dont-acc">Already have an account? <a href="<?php echo e(route('auth.login')); ?>">Log in now.</a></p>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="personal" role="tabpanel" aria-labelledby="personal-tab">
                                <form action="#">
                                    ...
                                    <div class="btn-area">
                                        <a href="<?php echo e(route('admin.home')); ?>" class="cmn-btn">Register Now</a>
                                    </div>
                                </form>
...
<?php echo $__env->make('admin.layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/cbaa8a44-147a-4ce3-a95c-72c7dc2b7daa/DoDoSoftec/OtopilotDashboard/resources/views/admin/auth/register.blade.php ENDPATH**/ ?>