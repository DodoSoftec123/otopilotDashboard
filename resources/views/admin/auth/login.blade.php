    ...
    <div class="overlay">
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-md-5">
                    <div class="img-area">
                        <img src="{{ asset('assets/auth/img/login-bg-2.png') }}" alt="image">
                    </div>
                </div>
                <div class="col-lg-6 col-md-7 z-1 text-center d-flex justify-content-center pb-120">
                    <div class="form-box">
                        <h4>Log in to Otopilot</h4>
                        <p class="dont-acc">Don't have an account? <a href="{{ route('auth.register') }}">Register</a></p>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="personal" role="tabpanel" aria-labelledby="personal-tab">
                                ...
                                <form action="#">
                                    ...
                                    <div class="btn-area">
                                        <a href="{{ route('admin.home') }}" class="cmn-btn">Log in</a>
                                    </div>
                                </form>
                            </div>
